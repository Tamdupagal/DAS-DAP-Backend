...
const { fetchTaskFlow, fetchMyTasks, createTask, getTask, deleteTask, updateTask, starred } = require('../../../../Utils/Tasks/Tasks.utils')
...
Router.route('/starredUnstarred').put(starred)
